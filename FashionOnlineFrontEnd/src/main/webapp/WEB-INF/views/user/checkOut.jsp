...
<body>
	<div class="container">
		...
		<div class="h2 text-center">Thank you for Shopping at FashionOnline. The amount of <b class="text-success"><i class="fa fa-inr" aria-hidden="true"></i> ${totalAmount}</b> will be received at the time of delivery.</div>
